const Adds=()=>{
    return(
        <>
        <div className="flex gap-9 ml-16 mt-10">

     
<div className="bg-[#54A6FF]  w-[580px] h-[360px] rounded-[10px]">
...
<h5 className="text-[32px] font-[600] text-white">The Best Platform for Car Rental</h5>
<h5 className="text-[16px] font-[500] text-white mt-4">Ease of doing a car rental safely and reliable.Of course at a low price</h5>
</div>

<button className="w-[120px] h-[44px] rounded-[4px] bg-[#3563E9] mt-4">Rental Car</button>

</div>



<div className="w-[410px] h-[116px] ml-[136px] mt-[-55px] ">
...
<div className="bg-[#3563E9] w-[580px] h-[360px] rounded-[10px]">
...
<div className="w-[379px] h-[116px] ml-[164px] mt-[-100px] mirror-x or scale-x-[-1]">
